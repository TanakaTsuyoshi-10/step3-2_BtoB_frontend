              ...
              <div className="h-full flex items-end justify-between border-b border-l border-gray-200 relative">
                ...
                <div className="flex items-end justify-between w-full h-full pb-8 px-4">
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">130kWh</div>
                    <div 
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">156kWh</div>
                    <div 
                      className="w-12 bg-yellow-500 rounded-t hover:bg-yellow-600 transition-colors cursor-pointer" 
                      style={{height: '78%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">90kWh</div>
                    <div 
                      className="w-12 bg-yellow-500 rounded-t hover:bg-yellow-600 transition-colors cursor-pointer" 
                      style={{height: '45%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">176kWh</div>
                    <div 
                      className="w-12 bg-yellow-500 rounded-t hover:bg-yellow-600 transition-colors cursor-pointer" 
                      style={{height: '88%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">144kWh</div>
                    <div 
                      className="w-12 bg-yellow-500 rounded-t hover:bg-yellow-600 transition-colors cursor-pointer" 
                      style={{height: '72%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-yellow-600">190kWh</div>
                    <div 
          ...
          <div className="bg-white rounded-lg border shadow-sm p-4 sm:p-6">
            ...
            <div className="h-80 pl-12">
              <div className="h-full flex items-end justify-between border-b border-l border-gray-200 relative">
                ...
                <div className="flex items-end justify-between w-full h-full pb-8 px-4">
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">27.5m³</div>
                    <div 
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">34m³</div>
                    <div 
                      className="w-12 bg-orange-500 rounded-t hover:bg-orange-600 transition-colors cursor-pointer" 
                      style={{height: '68%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">17.5m³</div>
                    <div 
                      className="w-12 bg-orange-500 rounded-t hover:bg-orange-600 transition-colors cursor-pointer" 
                      style={{height: '35%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">41m³</div>
                    <div 
                      className="w-12 bg-orange-500 rounded-t hover:bg-orange-600 transition-colors cursor-pointer" 
                      style={{height: '82%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">31m³</div>
                    <div 
                      className="w-12 bg-orange-500 rounded-t hover:bg-orange-600 transition-colors cursor-pointer" 
                      style={{height: '62%'}}
                    ></div>
                  ...
                  <div className="flex flex-col items-center space-y-2 relative group">
                    <div className="absolute -top-6 text-xs font-medium text-orange-600">46m³</div>
                    <div 
          ...
          <div className="h-80 pl-12">
            <div className="h-full border-b border-l border-gray-200 relative overflow-hidden">
              ...
              <svg className="w-full h-full" viewBox="0 0 300 200">
                <polyline
                  points="25,160 75,140 125,150 175,120 225,130 275,80"
                  fill="none"
                  stroke="#10b981"
                  strokeWidth="3"
                ...
                />
                <g className="group">
                  <circle cx="25" cy="160" r="4" fill="#10b981" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="25" cy="160" r="8" fill="transparent" className="cursor-pointer" />
                ...
                <g className="group">
                  <circle cx="75" cy="140" r="4" fill="#10b981" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="75" cy="140" r="8" fill="transparent" className="cursor-pointer" />
                  <foreignObject x="30" y="115" width="50" height="20">
                    <div className="flex justify-center">
                      <div className="bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        9月 CO2削減量(t):1.8
                      </div>
                ...
                <g className="group">
                  <circle cx="125" cy="150" r="4" fill="#10b981" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="125" cy="150" r="8" fill="transparent" className="cursor-pointer" />
                  <foreignObject x="80" y="125" width="50" height="20">
                    <div className="flex justify-center">
                      <div className="bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        10月 CO2削減量(t):1.5
                      </div>
                ...
                <g className="group">
                  <circle cx="175" cy="120" r="4" fill="#10b981" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="175" cy="120" r="8" fill="transparent" className="cursor-pointer" />
                  <foreignObject x="130" y="95" width="50" height="20">
                    <div className="flex justify-center">
                      <div className="bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        11月 CO2削減量(t):2.4
                      </div>
                ...
                <g className="group">
                  <circle cx="225" cy="130" r="4" fill="#10b981" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="225" cy="130" r="8" fill="transparent" className="cursor-pointer" />
                  <foreignObject x="180" y="105" width="50" height="20">
                    <div className="flex justify-center">
                      <div className="bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        12月 CO2削減量(t):2.1
                      </div>
                ...
                <g className="group">
                  <circle cx="275" cy="80" r="4" fill="#059669" className="drop-shadow-sm hover:r-6 transition-all cursor-pointer" />
                  <circle cx="275" cy="80" r="8" fill="transparent" className="cursor-pointer" />
                  <foreignObject x="230" y="55" width="50" height="20">
                    <div className="flex justify-center">
                      <div className="bg-gray-800 text-white px-2 py-1 rounded text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        1月 CO2削減量(t):3.6
                      </div>
