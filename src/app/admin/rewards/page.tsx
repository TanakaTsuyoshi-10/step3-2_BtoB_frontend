...
export default function Page() {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case '商品':
        return <Icon icon="heroicons:cube" className="w-5 h-5" />;
      case '社内サービス':
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 bg-primary-50 px-4 py-2 rounded-lg">
              <Icon icon="heroicons:currency-dollar" className="w-5 h-5 text-primary-600" />
                  ...
                  <div className="p-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          <Icon icon="heroicons:shopping-cart" className="w-4 h-4 inline mr-1" />
                          交換
                        </button>
                      </div>
                    </div>
